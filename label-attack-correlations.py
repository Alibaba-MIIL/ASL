...
for target_label in TARGET_LABELS:
    ...
    for i, (tensor_batch, labels) in enumerate(data_loader):
        ...
        adversarials = create_targeted_adversarial_examples(model, tensor_batch, target, target_ids=[target_label], eps=0.01, device="cuda")
        with torch.no_grad():
...
plt.show()
plt.savefig("lazy_attack-correlations.png")